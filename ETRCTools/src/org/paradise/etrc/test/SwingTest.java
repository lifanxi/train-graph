...
//            });            
    ...
    /**
     * 最右边模块，继承JPanel,初始化各种按钮 JPanel--+ --JButton  --JToggleButton -- JList -- JCombox --JCheckBox
     * ....
     */
    ...
    /**
     * 中间层模块，继承JPanel,初始化页签,并在页签中设置文本区，表格, 文本区上下用分隔条分隔 JPanel--+ -JTabbedPane--+ --Draw    --JTable
     * -JTextAreas -JText --JPopupMenu
     */
